...
class DrawEndWall1 extends React.Component {
    ...
    render(){
        const {dashLines, verticleArrows, horizontalArrows, boldLines, normalLines, slopes, allDoors, allBraces, allMullions, scale, isHidden, isQuotePrint, title, grid}
                    = this.props;
        return (
            <React.Fragment>

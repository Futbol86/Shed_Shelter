...
import {
    QUOTES_BUILDING_DETAIL_FORM_NAME, DRAW_LEFT_PADDING, DRAW_TOP_PADDING,
    WALL_TOP_INDEX, QUOTES_ACCESS_DOOR_OPENING_ORIENTATION_IDS, QUOTES_DOOR_TYPE_IDS, WINDOW_DISTANCE_TO_GROUND, 
...
class DrawTopSideWall extends React.Component {
    ...
    render() {
        ...
        var hasLeftAnnexe = isAnnexeLeft && annexeLeft && annexeLeft.height && annexeLeft.span;
...
export default connect(mapStateToProps, {})(DrawTopSideWall);
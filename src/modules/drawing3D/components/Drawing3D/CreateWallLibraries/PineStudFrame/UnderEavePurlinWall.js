...
import {
    ...
    EXTERN_WALL_CLADDING_NONE, EXTERN_WALL_CLADDINGS,
    ...
    createUnderEavePurlinInteriorWall(params, scene) {
        ...
        || (wallCladdingType === WALL_CLADDING_ONE_SIDE && (!externWallCladding || externWallCladding === EXTERN_WALL_CLADDING_NONE) )) {
            ...
            for(let i = 0; i < TOTAL_WALL_STUD; i++) {   
                ...
                newWallStudIW = wallStudIWSample.clone("studName");
                newWallStudIW.setEnabled(true);
                newWallStudIW.setPivotMatrix(BABYLON.Matrix.Translation(STUD_FLANGE/2, STUD_WEB/2, WALL_HEIGHT/2 + STUD_FLANGE/2), false);
            ...
            for(let i = 0; i < TOTAL_WALL_STUD - 1; i++) {
                ...
                newNogginIW = nogginIWSample.clone("nogginName");
        ...
        && externWallCladding !== EXTERN_WALL_CLADDING_NONE) {
            ...
            let externPlasterBoardMat = new BABYLON.StandardMaterial("extern-plaster-board-mat", scene);

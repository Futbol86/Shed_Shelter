...
const renderSignatures = ({fields, handleRemove}) => {
    return (
        <React.Fragment>
            <Row className="mb-2">
                <Col md="11">
                    <h4><FormattedMessage id="app.docs.Signatures" defaultMessage="Signatures" />:</h4>
                </Col>
                <Col md="1">
            ...
            <Row className="mb-2">
                <Col md="4" className="text-center">
                    <strong><FormattedMessage id="app.docs.Name_Role" defaultMessage="Name/Role"/></strong>
                </Col>
                <Col md="4" className="text-center">
...
class Signatures extends Component {
    render(){
        return (
            <Row className="mb-2">
                <Col md="12">
                    <FieldArray name="signatures" component={renderSignatures} handleRemove={this.props.handleSignaturesRemove}/>
                </Col>
            </Row>
        );
    }

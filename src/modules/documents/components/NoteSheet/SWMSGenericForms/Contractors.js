...
const renderContractors = ({fields, handleRemove}) => {
    return (
        <React.Fragment>
            <Row className="mb-2">
                <Col md="11">
                    <h4><FormattedMessage id="app.docs.SWMSContractors" defaultMessage="Contractors" />:</h4>
                </Col>
                <Col md="1">
...
class Contractors extends Component {
    render(){
        return (
            <Row className="mb-2">
                <Col md="12">
                    <FieldArray name="contractors" component={renderContractors} handleRemove={this.props.handleContractorsRemove}/>
                </Col>
            </Row>
        );
    }

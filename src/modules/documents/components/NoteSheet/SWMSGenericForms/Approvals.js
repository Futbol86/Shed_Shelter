...
const renderApprovals = ({fields, handleRemove}) => {
    return (
        <React.Fragment>
            <Row className="mb-2">
                <Col md="11">
                    <h4>
                        <FormattedMessage id="app.docs.Approvals" defaultMessage="Approvals (Manager, Leader , Section Manager, Controller)" />:
                    </h4>
                </Col>
                <Col md="1">
...
class Approvals extends Component {
    render(){
        return (
            <Row className="mb-2">
                <Col md="12">
                    <FieldArray name="approvals" component={renderApprovals} handleRemove={this.props.handleApprovalsRemove}/>
                </Col>
            </Row>
        );
    }
